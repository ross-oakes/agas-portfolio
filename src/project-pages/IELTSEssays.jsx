...
const IELTSEssays = () => (
    <PortfolioPage>
        ...
        <ProjectSection title="Competitive analysis and best practices">
            <p>
        ...
        <ProjectSection title="Persona creation">
            <p>
        ...
        <ProjectSection title="Improvements needed">
            <p>
        ...
        <ProjectSection title="Result and next steps">
            <p>
