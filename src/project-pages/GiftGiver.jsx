...
const GiftGiver = () => (
    <PortfolioPage>
        ...
        <ProjectSection title="Research and Analysis">
            ...
            <ProjectSubsection title="Competitor analysis">
                <p>
        ...
        <ProjectSection title="Functionality design decisions">
            <ProjectSubsection>
                <p>
            ...
            <ProjectSubsection title="Categories">
                <p>
            ...
            <ProjectSubsection title="Filter and sort">
                <p>
        ...
        <ProjectSection id="final-design" title="Final design">
            ...
            <ProjectSubsection title="The result">
                <p>
            ...
            <ProjectSubsection title="What could have been better">
                <p>
