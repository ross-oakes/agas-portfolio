...
const Machining = () => (
    <PortfolioPage>
        ...
        <ProjectSection title="Existing Website">
        ...
        <ProjectSection title="User research and competitive analysis">
            <p>
        ...
        <ProjectSection title="My design process">
        ...
        <ProjectSection title="Landing Page">
            <p>
        ...
        <ProjectSection title="About Us Page">
            <p>
        ...
        <ProjectSection title="Services Page">
            <p>
        ...
        <ProjectSection title="Work With Us Page">
            <p>
        ...
        <ProjectSection title="Gallery Page">
            <p>
        ...
        <ProjectSection title="Contact Page">
            <p>
        ...
        <ProjectSection title="The result and next steps">
            <p>
