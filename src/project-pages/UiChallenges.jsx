...
const UiChallenges = () => (
    <PortfolioPage>
        ...
        <ProjectSection title="Banking App">
            <p>
        ...
        <ProjectSection title="Travel inspiration landing page">
            <p>
        ...
        <ProjectSection title="Sign Up Page">
            <p>
        ...
        <ProjectSection title="Credit Card Checkout">
            <p>
        ...
        <ProjectSection title="Fitness App Dashboard">
            <p>
        ...
        <ProjectSection title="User Profile">
            <p>
